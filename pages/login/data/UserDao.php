...
class UserDao extends Connection{
    ...
    {
      echo 'okk';
         $query = "INSERT INTO users (name,email,user,password,privilege) VALUES (:name,:email,:user,:password,:privilege)";
      ...
      $result->bindValue(":password", $user->getPassword());
      $result->bindValue(":privilege",(int) $user->getPrivilege(), PDO::PARAM_INT);
